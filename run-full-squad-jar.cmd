...
IF EXIST spring-base rmdir /s /q spring-base
IF EXIST spring-base-event rmdir /s /q spring-base-event

git clone https://github.com/vulinh64/spring-base.git
git clone https://github.com/vulinh64/spring-base-event.git

call ./spring-base/mvnw.cmd clean install -DskipTests -f ./spring-base/pom.xml
call ./spring-base-event/mvnw.cmd clean install -DskipTests -f ./spring-base-event/pom.xml
